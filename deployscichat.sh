...
helm install  --namespace dev --name local-postgresql --set postgresqlPassword=${MY_POSTGRES},postgresqlDatabase=synapse,postgresqlUser=synapse stable/postgresql
