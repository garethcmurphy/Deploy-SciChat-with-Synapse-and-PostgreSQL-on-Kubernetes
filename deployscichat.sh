...
helm install stable/postgresql  --namespace dev --name local-postgresql --set postgresqlPassword=${POSTGRES_PASSWORD},postgresqlDatabase=my-database   -f postgres/values.yaml
