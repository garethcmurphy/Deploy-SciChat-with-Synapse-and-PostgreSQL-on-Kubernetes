...
helm install  --namespace dev --name local-postgresql --set postgresqlPassword=${POSTGRES_PASSWORD},postgresqlDatabase=synapse,postgresqlUser=synapse stable/postgresql
